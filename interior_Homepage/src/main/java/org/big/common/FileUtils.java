...
public class FileUtils {
   ...
   public List<PhotoDto> parseFileInfo(int iphotoId, MultipartHttpServletRequest multipartHttpServletRequest) throws Exception{
      ...
      List<PhotoDto> fileList = new ArrayList<>();
      
      DateTimeFormatter format = DateTimeFormatter.ofPattern("yyyyMMdd"); 
       ZonedDateTime current = ZonedDateTime.now();
       String path = "C:/Temp/photo/images/"+current.format(format);
      ...
      for (String fieldName : fileFieldNames) {
          ...
          for (MultipartFile multipartFile : list) {
              if (!multipartFile.isEmpty()) {
                  ...
                  photo.setIphotoId(iphotoId);
                  photo.setIphotoUrl(path + "/" + newFileName);
                  fileList.add(photo);
